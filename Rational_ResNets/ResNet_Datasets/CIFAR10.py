...
def get_train_data(aug: bool = False, bs: int = 128):
    ...
    train_val_set = torchvision.datasets.CIFAR10(root='/home/viktoria/Git/thesis_stuff/data/cifar10', train=True, download=True, transform=data_transform)
...
def get_test_data(aug: bool = False, bs: int = 128):
    ...
    if aug:
        ...
        data_transform = transform
    testset = torchvision.datasets.CIFAR10(root='/home/viktoria/Git/thesis_stuff/data/cifar10', train=False, download=True, transform=data_transform)
