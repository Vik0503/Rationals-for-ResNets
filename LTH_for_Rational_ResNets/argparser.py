...
def get_arguments():
    ...
    LTH_args = LTH_arg_parser.parse_args(['--model', 'univ_rational_resnet20', '--dataset', 'SVHN', '--warmup_iterations', '7167', '--training_number_of_epochs', '15',
                                          '--stop_criteria', 'test_acc', '--save_res_csv', '-test_acc', '92'])
