...
from LTH_for_Rational_ResNets import argparser, utils
...
class RationalResNet(nn.Module):
    ...
    def __init__(self, block: Type[RationalBasicBlock], layers: List[int], rational_inits: List[str], num_rationals: int, num_classes: int = 1000, mask: Mask = None) -> None:
        """
...
def mix_exp_resnet18(mask: Mask = None, **kwargs: Any) -> RationalResNet:
