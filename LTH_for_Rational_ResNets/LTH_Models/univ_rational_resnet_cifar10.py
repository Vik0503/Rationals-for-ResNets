...
def univ_rational_resnet20(mask: Mask = None, **kwargs: Any) -> RationalResNet:
    """ResNet20 for CIFAR10 as mentioned in the paper above with Rationals as activation function"""
