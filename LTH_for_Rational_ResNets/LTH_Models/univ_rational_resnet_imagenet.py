...
def univ_rational_resnet18(mask: Mask = None, **kwargs: Any) -> RationalResNet:
    """ResNet for ImageNet as mentioned in the paper above"""
    return _resnet('resnet18', RationalBasicBlock, [2, 2, 2, 2], mask=mask, **kwargs)


def univ_rational_resnet18_2_layers(mask: Mask = None, **kwargs: Any) -> RationalResNet:
    """ResNet for ImageNet as mentioned in the paper above"""
    return _resnet('resnet18', RationalBasicBlock, [2, 2], mask=mask, **kwargs)


def univ_rational_resnet18_1_layer(mask: Mask = None, **kwargs: Any) -> RationalResNet:
    """ResNet for ImageNet as mentioned in the paper above"""
